...
const Detailstrack = () => {
  ...
  return (
    <TouchableWithoutFeedback onPress={closeDropdowns}>
      ...
      <Image source={require('@/assets/images/emptytrack.png')} style={styles.iconImage} />
        <Text style={styles.title}>Track Circuit - 201</Text>
      ...
      <View style={styles.details}>
        <Text style={styles.detailText1}>Status: Vacant</Text>
        <View style={styles.verticalLine} />
        <Text style={styles.detailText2}>TR Current: 2a</Text>
        <View style={styles.verticalLine} />
        <Text style={styles.detailText3}>TR Voltage: 1v</Text>
        <TouchableOpacity onPress={() => toggleDropdown('card1')}>
              
        <Icon
                  name={
                    dropdownVisibility['card1'] ? 'chevron-up' : 'chevron-down'
                  }
                  size={10}
                  color="#333"
                  style={styles.icon}
      ...
      {dropdownVisibility['card1'] && (
            <>
              <View style={styles.line} />
              <View style={styles.details}>
              <Text style={styles.detailText1}>TPR Voltage: 1v</Text>
        <View style={styles.verticalLine} />
        <Text style={styles.detailText2}>TPR Current: 2a</Text>
        <View style={styles.verticalLine} />
        <Text style={styles.detailText3}>C.O-Voltage: 2v</Text>
              </View>
              <View style={styles.line} />
              <View style={styles.details}>
                <Text style={styles.detailText1}>C.O-Current: 1a</Text>
                <View style={styles.verticalLine} />
                <Text style={styles.detailText2}>TF Volatge: 2v</Text>
                <View style={styles.verticalLine} />
                <Text style={styles.detailText3}>TF Current: 1a</Text>
              </View>
            </>
      ...
      {/* Header Section */}
      <View style={styles.header}>
      <Image source={require('@/assets/images/trainwithtrack.png')} style={styles.iconImage} />
        <Text style={styles.title}>Track Circuit - 202</Text>
      ...
      {/* Details Section */}
      <View style={styles.details}>
        <Text style={styles.detailText1}>Status: Occupied</Text>
        <View style={styles.verticalLine} />
        <Text style={styles.detailText2}>TR Current: 2a</Text>
        <View style={styles.verticalLine} />
        <Text style={styles.detailText3}>TR Voltage: 1v</Text>
        <TouchableOpacity onPress={() => toggleDropdown('card2')}>
              
        <Icon
                  name={
                    dropdownVisibility['card2'] ? 'chevron-up' : 'chevron-down'
                  }
                  size={10}
                  color="#333"
                  style={styles.icon}
      ...
      <View style={styles.header}>
      <Image source={require('@/assets/images/trainwithtrack.png')} style={styles.iconImage} />
        <Text style={styles.title}>Track Circuit - 203</Text>
      ...
      <View style={styles.details}>
        ...
        <View style={styles.verticalLine} />
        <Text style={styles.detailText3}>TR Voltage: 1v</Text>
        <TouchableOpacity onPress={() => toggleDropdown('card3')}>
              
        <Icon
                  name={
                    dropdownVisibility['card3'] ? 'chevron-up' : 'chevron-down'
                  }
                  size={10}
                  color="#333"
                  style={styles.icon}
