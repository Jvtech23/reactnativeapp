...
const detailsaxle = () => {
  ...
  <View style={styles.header}>
    ...
    <Text style={styles.title}>Axle Counter - 101</Text>
...
<View style={styles.card}> 
  ...
  <View style={styles.header}>
    <Image source={require('@/assets/images/ax1.png')} style={styles.iconImage} />
    <Text style={styles.title}>Axle Counter - 102</Text>
...
<View style={styles.card}> 
  ...
  <View style={styles.header}>
    <Image source={require('@/assets/images/ax1.png')} style={styles.iconImage} />
    <Text style={styles.title}>Axle Counter - 103</Text>
...
<View style={styles.card}> 
  ...
  <View style={styles.header}>
    <Image source={require('@/assets/images/ax1.png')} style={styles.iconImage} />
    <Text style={styles.title}>Axle Counter - 104</Text>
